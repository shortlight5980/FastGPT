...
export enum AuditEventEnum {
  ...
  RESUME_INHERIT_PERMISSION = 'RESUME_INHERIT_PERMISSION',
  SYNC_DATASET = 'SYNC_DATASET',
  EXPORT_DATASET = 'EXPORT_DATASET',
  REBUILD_DATASET_INDEX = 'REBUILD_DATASET_INDEX',
  EXPORT_DATASET_CONTENT = 'EXPORT_DATASET_CONTENT',
  TRANSFER_TEAM_OWNERSHIP = 'TRANSFER_TEAM_OWNERSHIP',
  CREATE_DATASET_FOLDER = 'CREATE_DATASET_FOLDER',
  //Collection
  CREATE_COLLECTION = 'CREATE_COLLECTION',
  IMPORT_DATASET_CONTENT = 'IMPORT_DATASET_CONTENT',
  UPDATE_COLLECTION = 'UPDATE_COLLECTION',
  DELETE_COLLECTION = 'DELETE_COLLECTION',
  RETRAIN_COLLECTION = 'RETRAIN_COLLECTION',
  RETRY_TRAINING = 'RETRY_TRAINING',
  CLEAN_TRAINING_RECORD = 'CLEAN_TRAINING_RECORD',
  RENAME_DATASET_TAG = 'RENAME_DATASET_TAG',
  DELETE_DATASET_TAG = 'DELETE_DATASET_TAG',
  ADD_DATASET_TAGS = 'ADD_DATASET_TAGS',
  REMOVE_DATASET_TAGS = 'REMOVE_DATASET_TAGS',
  CREATE_DATASET_TAG = 'CREATE_DATASET_TAG',
  //Data
  ...
  ACCOUNT_CANCELLATION_SUBMIT = 'ACCOUNT_CANCELLATION_SUBMIT',
  ACCOUNT_CANCELLATION_CANCEL = 'ACCOUNT_CANCELLATION_CANCEL',
  ACCOUNT_CANCELLATION_FINALIZE = 'ACCOUNT_CANCELLATION_FINALIZE',
