...
export enum SendInformTemplateCodeEnum {
  ...
  ACCOUNT_DELETION_CODE = 'ACCOUNT_DELETION_CODE', // 账号注销验证码

  EXPIRE_SOON = 'EXPIRE_SOON', // 即将过期
  EXPIRED = 'EXPIRED', // 已过期
  FREE_CLEAN = 'FREE_CLEAN', // 免费版清理

  ACCOUNT_DELETION_7D = 'ACCOUNT_DELETION_7D',
  ACCOUNT_DELETION_1D = 'ACCOUNT_DELETION_1D',
  ACCOUNT_DELETION_TODAY = 'ACCOUNT_DELETION_TODAY',
